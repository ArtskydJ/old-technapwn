...
AutoStep("BackToStartTile",  -100, 0,     STRAIGHT,          BACKWARD,   800,  0,      0,      NOCONDITION,         0 );
...
AutoStep("FetchBall",        -100, IN,    STRAIGHT,          FORWARD,    2000, 0,      0,      NOCONDITION,         0 );
...
AutoStep("Finished!",        0,    0,     STRAIGHT,          0,          -1,   0,      0,      NOCONDITION,         0 );
	...
	{
AutoName("BluInterStraight");
AutoStep("Raise Lift",       HIGHGOALHEIGHT,0,     STRAIGHT,          0,          200,  0,      0,      NOCONDITION,         0 );
AutoStep("DriveToGoal+Lift", HIGHGOALHEIGHT,0,     STRAIGHT,          FORWARD,    1500, 0,      0,      NOCONDITION,         0 );
AutoStep("WaitForStableBot", HIGHGOALHEIGHT,0,     STRAIGHT,          0,          750,  0,      0,      NOCONDITION,         0 );
AutoStep("Release Elements", HIGHGOALHEIGHT,OUT,   STRAIGHT,          0,          2750, 0,      0,      NOCONDITION,         0 );
AutoStep("StopIntake+Pause", HIGHGOALHEIGHT,STOP,  STRAIGHT,          0,          0,    0,      0,      NOCONDITION,         0 );
AutoStep("Rotate",           0,    0,     BOTHWHEELTURN,     LEFT,       100,  0,      0,      NOCONDITION,         0 );
AutoStep("BackToStartTile",  HIGHGOALHEIGHT,0,     STRAIGHT,          BACKWARD,   1300, 0,      0,      NOCONDITION,         0 );
AutoStep("HitABtnToGoAgain", 0,    0,     STRAIGHT,          0,          0,    0,      0,      ANYDISPLAYBUTTON,    2 );
AutoStep("HitABtnToGoAgain", 0,    0,     STRAIGHT,          0,          0,    0,      0,      NOCONDITION,         8 );
AutoStep("Finished!",        0,    0,     STRAIGHT,          0,          -1,   0,      0,      NOCONDITION,         0 );
	}
	...
	{
	  AutoName("RedIsolatioTines");
		AutoStep("Raise Lift",       2000, 0,     STRAIGHT,          0,          500,  0,      0,      NOCONDITION,         0 );
		AutoStep("DriveToGoal+Lift", 873,  0,     STRAIGHT,          FORWARD,    500,  0,      0,      NOCONDITION,         0 );
		AutoStep("Lower Tines",      873,  0,     TINES,             EXTENDED,   0,    0,      0,      NOCONDITION,         0 );
		AutoStep("DriveToGoal+Lift", 873,  0,     STRAIGHT,          FORWARD,    2000, 0,      0,      NOCONDITION,         0 );
		AutoStep("Pause",            873,  0,     STRAIGHT,          0,          250,  0,      0,      NOCONDITION,         0 );
		AutoStep("ReleaseTheMffins", 873,  OUT,   STRAIGHT,          0,          7000, 0,      0,      NOCONDITION,         0 );
		AutoStep("Done!",            0,    STOP,  STRAIGHT,          0,          -1,   0,      0,      NOCONDITION,         0 );
  }
