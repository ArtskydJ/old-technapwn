...
#pragma config(Motor,  port1,           DriveLB,       tmotorNormal, openLoop)
#pragma config(Motor,  port5,           DriveRF,       tmotorNormal, openLoop, reversed)
#pragma config(Motor,  port6,           DriveLF,       tmotorNormal, openLoop)
#pragma config(Motor,  port10,          DriveRB,       tmotorNormal, openLoop, reversed)
