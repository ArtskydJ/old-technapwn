...
task show_variables()
{
	...
	string VariableMenu[9] = {"MainBatteryLvl", "LiftEncoder", "LeftLineFollower", "RightLineFolower", "BothLineFollower", "gyrGyroscope", "LeftDriveEncoder", "RightDriveEncoder", "IntegLiftEncoder"};
	while(true)
	{
		if (DisplayNeedsRefreshing)
		{
		...
		if (CurrentMenuItem == 0)
			...
			VariableValue = (float) LeftLineFollower;
		else if (CurrentMenuItem == 3)
			VariableValue = (float) RightLineFollower;
		else if (CurrentMenuItem == 4)
			VariableValue = (float) LeftLineFollower * 10000 + RightLineFollower;
		else if (CurrentMenuItem == 5)
			VariableValue = (float) gyrGyroscope;
		else if (CurrentMenuItem == 6)
			VariableValue = (float) LeftDriveIntegratedEncoder;
		else if (CurrentMenuItem == 7)
			VariableValue = (float) RightDriveIntegratedEncoder;
		else if (CurrentMenuItem == 8)
			VariableValue = (float) LiftIntegratedEncoder;
